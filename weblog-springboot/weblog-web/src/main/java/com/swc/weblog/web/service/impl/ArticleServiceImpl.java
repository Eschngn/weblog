...
import com.swc.weblog.common.domain.dos.*;
import com.swc.weblog.common.domain.mapper.*;
...
import com.swc.weblog.web.markdown.MarkdownHelper;
import com.swc.weblog.web.model.vo.article.*;
import com.swc.weblog.web.model.vo.category.FindCategoryListRspVO;
import com.swc.weblog.web.model.vo.tag.FindTagListRspVO;
import com.swc.weblog.web.service.ArticleService;
import com.swc.weblog.web.utils.MarkdownStatsUtil;
...
public class ArticleServiceImpl implements ArticleService {
    ...
    public Response findArticlePageList(FindIndexArticlePageListReqVO findIndexArticlePageListReqVO) {
        ...
        if(!CollectionUtils.isEmpty(articleDOS)){
            ...
            vos.forEach(vo->{
                Long curArticleId = vo.getId();
                // 过滤出当前文章对应的关联数据
                Optional<ArticleCategoryRelDO> optional  = articleCategoryRelDOS.stream().filter(rel -> Objects.equals(rel.getArticleId(), curArticleId)).findAny();
